...
from model.decoder_fpn_aspp import ResNet_FPN_Net
import model
from lib import *
from loss import *
from dataset import *
...
if args.model == "unet-resnet":
    model = smp.Unet('resnet34', encoder_weights='imagenet', classes=2, activation=None, encoder_depth=5, decoder_channels=[256, 128, 64, 32, 16])
    ...
    print("yb")
    model = ResNet_FPN_Net()
    #model = smp.Unet('mobilenet_v2', encoder_weights='imagenet', classes=2, activation=None, encoder_depth=5,
